...
speak('Hello, ')
speak('hello')
speak('hello i dont think we have met. ,  i  am extremely excited to get to know each other and form a new relationship. please give me a name ')
myname = input("what is my name")
speak (myname + "is my name")
